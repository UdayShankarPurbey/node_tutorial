...
const insertSampleProduct = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Error inserting sample product' });
  }
};
...
const getProductStats = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Error getting product stats' });
  }
};
...
const getProductAnalysis = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Error getting product analysis' });
  }
};
